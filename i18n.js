(function () {
  const translations = {
    ko: {
      ...
      seedTestData: "테스트 데이터 생성",
      resetDemoData: "DB 초기화",
      dbStatus: "DB 상태",
      checkingDb: "DB 연결 확인 중...",
      dbConnected: "DB 연결됨",
      dbNotConnected: "DB 미연결:",
      refresh: "새로고침",
      testDataSeeded: "테스트 데이터를 생성했습니다.",
      demoDataReset: "DB 초기화 데이터를 저장했습니다.",
      confirmSeedTestData: "현재 데이터에 테스트 데이터를 추가/갱신할까요?",
      confirmResetDemoData: "요청 내역을 비우고 메뉴/레시피/재료를 기본값으로 초기화할까요?",
      orderCsv: "주문 리스트 CSV",
      recipeCsv: "레시피 CSV",
    ...
    en: {
      ...
      resetDemoData: "Reset DB",
      dbStatus: "DB Status",
      checkingDb: "Checking DB connection...",
      dbConnected: "DB connected",
      dbNotConnected: "DB not connected:",
      refresh: "Refresh",
      testDataSeeded: "Test data has been created.",
      demoDataReset: "Reset data has been saved.",
      confirmSeedTestData: "Add or refresh test data now?",
      confirmResetDemoData: "Clear request history and reset menus, recipes, and ingredients to defaults?",
