(function () {
  ...
  const sectionLabels = {
    ko: { "반조리": "반조리", "야채": "야채", "반찬": "반찬", "소스": "소스", "식재료": "식재료", "상온": "상온", "냉장": "냉장", "냉동": "냉동", "기타": "기타", "고기": "고기", "해물": "해물", "신선": "신선", "두부": "두부", "분말": "분말", "소스류": "소스류", "곡류": "곡류", "면류": "면류", "포장 박스": "포장 박스", "식사": "식사", "찌개": "찌개", "사이드": "사이드", "분식": "분식", "덮밥": "덮밥", "국": "국", "면": "면" },
    en: { "반조리": "Semi-prepared", "야채": "Vegetables", "반찬": "Side Dishes", "소스": "Sauces", "식재료": "Ingredients", "상온": "Room Temp", "냉장": "Refrigerated", "냉동": "Frozen", "기타": "Other", "고기": "Meat", "해물": "Seafood", "신선": "Fresh", "두부": "Tofu", "분말": "Powder", "소스류": "Sauces", "곡류": "Grains", "면류": "Noodles", "포장 박스": "Packaging", "식사": "Meals", "찌개": "Stews", "사이드": "Sides", "분식": "Bunsik", "덮밥": "Rice Bowls", "국": "Soups", "면": "Noodles" }
  };
