...
| 먹자 | 부서 DB 등록 | 자기 부서 요청/메모 | 자기 부서 요청 조회 | 사용 불가 | 사용 불가 | 조회 | 사용 불가 |
| 레스토랑 | `m1234` | 전체 요청/출고 체크 | 전체 요청 조회 | 주문 모드 | 메뉴/레시피 조회 | 조회 | 사용 불가 |
...
- 부서/카테고리별 품목 그룹 표시
- 레스토랑/관리자 이동 컨트롤
- 레스토랑/관리자 부서별 전체 접기/펼치기
- 레스토랑/관리자 카테고리 접기/펼치기
- 권한별 홈 체크 저장
- 관리자/먹자 사용자 입고 체크 저장
- 그 외 사용자 출고 체크 저장
- 요청별 메모 작성
...
- [ ] 관리자/레스토랑 홈에서 이동 컨트롤이 보인다.
- [ ] 일반 부서 권한 홈에서는 이동 컨트롤이 숨겨진다.
- [ ] 관리자/레스토랑 홈에서 부서 접기/펼치기가 동작한다.
- [ ] 관리자/레스토랑 홈에서 카테고리 접기/펼치기가 동작한다.
